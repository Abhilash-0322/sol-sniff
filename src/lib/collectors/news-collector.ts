import { BaseCollector, type CollectorResult } from './base-collector';
import type { SignalSource } from '../types';

const NEWS_SOURCES = [
    { name: 'CoinDesk', url: 'https://www.coindesk.com/arc/outboundfeeds/rss/', searchTerms: ['solana', 'SOL', 'phantom', 'jupiter', 'jito'] },
    { name: 'The Block', url: 'https://www.theblock.co/rss.xml', searchTerms: ['solana', 'SOL'] },
    { name: 'Decrypt', url: 'https://decrypt.co/feed', searchTerms: ['solana', 'SOL', 'phantom'] },
];
