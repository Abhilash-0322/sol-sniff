...
import type { NarrativeListItem, IdeaItem, SignalItem, AnalysisStatus } from '@/src/lib/types';
import { Activity, Zap, Radio, ArrowUp, ArrowRight, ArrowDown, Lightbulb, Search, Flame, Loader2 } from 'lucide-react';
  ...
  async function loadData() {
    try {
      const [narrativesRes, ideasRes, signalsRes, statusRes] = await Promise.allSettled([
        ...
        fetch(`/api/signals?pageSize=10`).then(r => r.json()),
